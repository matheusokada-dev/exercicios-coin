...
public class ApiNumerarioClient {
    ...
    private static final ParameterizedTypeReference<PaginaResponse<SolicitacaoNumerarioResponse>>
            PAGINA_SOLICITACOES_NUMERARIO = new ParameterizedTypeReference<>() {
            };
    private static final ParameterizedTypeReference<PaginaResponse<OperacaoNumerarioResponse>>
            PAGINA_OPERACOES_NUMERARIO = new ParameterizedTypeReference<>() {
            };
    ...
    public PaginaResponse<AgenciaResponse> listarAgencias(
        ...
        return apiNumerarioRestClient.get()
                .uri(
                        builder -> builder.path("/api/v1/agencias")
                                .queryParamIfPresent(
                                        "busca",
                                ...
                                .queryParamIfPresent(
                                        "ativo",
                                        Optional.ofNullable(ativo)
                                )
                                .queryParamIfPresent(
                                        "alerta",
                                        Optional.ofNullable(alerta)
                                )
                                .queryParamIfPresent(
                                        "ordenarPor",
                                        Optional.ofNullable(ordenarPor)
                                )
                                .queryParamIfPresent(
                                        "direcao",
                                        Optional.ofNullable(direcao)
                                )
                                .queryParam(
                                        "pagina",
                                        pagina
    ...
    public AgenciaResponse criarAgencia(String authorization, CriarAgenciaRequest request) {
        return executarPost(
                ...
                null,
                request,
                AgenciaResponse.class
        );
    }

    public AgenciaResponse atualizarAgencia(String authorization, Long id, AtualizarAgenciaRequest request) {
    ...
    public PaginaResponse<SolicitacaoResponse> listarSolicitacoes(
        ...
        return apiNumerarioRestClient.get()
                .uri(
                        builder -> builder.path("/api/v1/solicitacoes")
                                .queryParamIfPresent(
                                        "agenciaId",
                                        Optional.ofNullable(agenciaId)
                                )
                                .queryParamIfPresent(
                                        "status",
    ...
    public SolicitacaoResponse criarSolicitacao(String authorization, SolicitarAbastecimentoRequest request) {
        return executarPost(
                "/api/v1/solicitacoes",
                authorization,
                null,
                request,
                SolicitacaoResponse.class
        );
    }

    public SolicitacaoResponse aprovarSolicitacao(String authorization, Long id, AprovarSolicitacaoRequest request) {
        return apiNumerarioRestClient.put()
                .uri(
    ...
    public SolicitacaoResponse rejeitarSolicitacao(String authorization, Long id, RejeitarSolicitacaoRequest request) {
        return apiNumerarioRestClient.put()
                .uri(
                        "/api/v1/solicitacoes/{id}/rejeitar",
                        id
                )
                .header(
                        HttpHeaders.AUTHORIZATION,
    ...
    public SolicitacaoResponse atenderSolicitacao(String authorization, Long id, AtenderSolicitacaoRequest request) {
        return apiNumerarioRestClient.put()
                .uri(
                        "/api/v1/solicitacoes/{id}/atender",
                        id
                )
                .header(
                        HttpHeaders.AUTHORIZATION,
    ...
    public PaginaResponse<MovimentacaoResponse> listarMovimentacoes(
        ...
        return apiNumerarioRestClient.get()
                .uri(
                        builder -> builder.path("/api/v1/movimentacoes")
                                .queryParamIfPresent(
                                        "agenciaId",
                                        Optional.ofNullable(agenciaId)
                                )
    ...
    public PaginaResponse<SolicitacaoNumerarioResponse> listarSolicitacoesNumerario(
        ...
        return apiNumerarioRestClient.get()
                .uri(
                        builder -> builder.path("/api/v1/solicitacoes-numerario")
                                .queryParamIfPresent(
                                        "agenciaId",
                                        Optional.ofNullable(agenciaId)
                                )
                                ...
                                .queryParamIfPresent(
                                        "origemId",
                                        Optional.ofNullable(origemId)
                                )
                                .queryParamIfPresent(
                                        "destinoId",
                                        Optional.ofNullable(destinoId)
                                )
                                .queryParamIfPresent(
                                        "dataInicio",
                                        Optional.ofNullable(dataInicio)
                ...
                .retrieve()
                .body(PAGINA_SOLICITACOES_NUMERARIO);
    }

    public DetalheSolicitacaoNumerarioResponse detalharSolicitacaoNumerario(String authorization, Long id) {
        return apiNumerarioRestClient.get()
                .uri(
                        "/api/v1/solicitacoes-numerario/{id}",
                        id
                )
                .header(
                        HttpHeaders.AUTHORIZATION,
    ...
    public List<HistoricoSolicitacaoResponse> consultarHistoricoSolicitacao(String authorization, Long id) {
        return apiNumerarioRestClient.get()
                .uri(
                ...
                .retrieve()
                .body(HISTORICO_SOLICITACAO);
    }

    public List<UnidadeOperacionalResponse> listarUnidadesOperacionais(String authorization, String tipo) {
        return apiNumerarioRestClient.get()
                .uri(
                        builder -> builder.path("/api/v1/unidades-operacionais")
                                .queryParamIfPresent(
                                        "tipo",
                                        Optional.ofNullable(tipo)
                                )
    ...
    public PaginaResponse<OperacaoNumerarioResponse> listarOperacoesNumerario(
        ...
        return apiNumerarioRestClient.get()
                .uri(
                        builder -> builder.path("/api/v1/operacoes-numerario")
                                .queryParamIfPresent(
                                        "status",
                                        Optional.ofNullable(status)
                                )
                ...
                .retrieve()
                .body(PAGINA_OPERACOES_NUMERARIO);
    }

    public SolicitacaoNumerarioResponse criarSolicitacaoNumerario(
            String auth,
    ...
    public SolicitacaoNumerarioResponse decidirSolicitacaoNumerario(
            String auth,
            Long id,
            String acao,
            DecidirSolicitacaoNumerarioRequest request) {
        return executarPut(
                "/api/v1/solicitacoes-numerario/" + id + "/" + acao,
                auth,
                null,
                request,
                SolicitacaoNumerarioResponse.class
    ...
    public OperacaoNumerarioResponse programarOperacao(
            String auth,
            Long id,
            String key,
            ProgramarOperacaoNumerarioRequest request) {
        return executarPut(
                "/api/v1/solicitacoes-numerario/" + id + "/programar",
                auth,
                key,
                request,
    ...
    public OperacaoNumerarioResponse iniciarSeparacao(String auth, Long id, VersaoOperacaoNumerarioRequest request) {
        return executarPut(
                "/api/v1/solicitacoes-numerario/" + id + "/iniciar-separacao",
                auth,
                null,
                request,
                OperacaoNumerarioResponse.class
    ...
    public OperacaoNumerarioResponse expedirOperacao(
            String auth,
            Long id,
            String key,
            ExecutarOperacaoNumerarioRequest request) {
        return executarPut(
                "/api/v1/solicitacoes-numerario/" + id + "/expedir",
                auth,
                key,
                request,
                OperacaoNumerarioResponse.class
    ...
    public OperacaoNumerarioResponse registrarOcorrencia(
            String auth,
            Long id,
            OcorrenciaOperacaoNumerarioRequest request) {
        return executarPut(
                "/api/v1/solicitacoes-numerario/" + id + "/registrar-ocorrencia",
                auth,
                null,
                request,
                OperacaoNumerarioResponse.class
    ...
    public OperacaoNumerarioResponse receberOperacao(
            String auth,
            Long id,
            String key,
            ReceberOperacaoNumerarioRequest request) {
        return executarPut(
                "/api/v1/solicitacoes-numerario/" + id + "/receber",
                auth,
                key,
                request,
                OperacaoNumerarioResponse.class
    ...
    public OperacaoNumerarioResponse conciliarOperacao(
            String auth,
            Long id,
            String key,
            ConciliarOperacaoNumerarioRequest request) {
        return executarPut(
                "/api/v1/solicitacoes-numerario/" + id + "/conciliar",
                auth,
                key,
                request,
                OperacaoNumerarioResponse.class
    ...
    public UnidadeOperacionalResponse realizarCargaInicial(
            String auth,
            String key,
            CargaInicialTesourariaRequest request) {
        return executarPost(
                "/api/v1/tesouraria/carga-inicial",
                auth,
                key,
                request,
    ...
    public UnidadeOperacionalResponse ajustarDivergencia(
            String auth,
            Long id,
            String key,
            AjustarDivergenciaRequest request) {
        return executarPost(
                "/api/v1/solicitacoes-numerario/" + id + "/ajustes-divergencia",
                auth,
                key,
                request,
                UnidadeOperacionalResponse.class
    ...
    private <T> T executarPut(String uri, String auth, String key, Object body, Class<T> response) {
        var request = apiNumerarioRestClient.put()
                .uri(uri)
                .header(
                        HttpHeaders.AUTHORIZATION,
                        auth
    ...
    private <T> T executarPost(String uri, String auth, String key, Object body, Class<T> response) {
        var request = apiNumerarioRestClient.post()
                .uri(uri)
                .header(
                        HttpHeaders.AUTHORIZATION,
                        auth
