...
public class OperacaoNumerarioEntity {
    ...
    @JoinColumn(name = "origem_agencia_id", nullable = false)
    private AgenciaEntity origem;
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "destino_agencia_id", nullable = false)
    ...
    @JoinColumn(name = "programado_por_id")
    private UsuarioEntity programadoPor;
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "expedido_por_id")
    private UsuarioEntity expedidoPor;
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "recebido_por_id")
    private UsuarioEntity recebidoPor;
    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "conciliado_por_id")
    private UsuarioEntity conciliadoPor;
    @Column(
            name = "data_programacao",
            nullable = false
    )
    private Instant dataProgramacao;
    ...
    public OperacaoNumerarioEntity(
            Long id,
            ...
            UsuarioEntity programadoPor,
            UsuarioEntity expedidoPor,
            UsuarioEntity recebidoPor,
            UsuarioEntity conciliadoPor,
        ...
        this.conciliadoPor = conciliadoPor;
