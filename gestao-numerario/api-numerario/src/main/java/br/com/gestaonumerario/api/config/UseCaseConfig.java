...
public class UseCaseConfig {
    ...
    SolicitacaoNumerarioUseCase solicitacaoNumerarioService(
        ...
        return new SolicitacaoNumerarioUseCase(
                numerarioPort,
                usuarioPort,
                relogioPort,
                transacaoPort
    ...
    OperacaoNumerarioUseCase operacaoNumerarioService(
            ...
            RelogioOutputPort relogioPort,
            TransacaoOutputPort transacaoPort) {
        return new OperacaoNumerarioUseCase(
                numerarioPort,
                usuarioPort,
                relogioPort,
                transacaoPort
    ...
    FinanceiroNumerarioUseCase financeiroNumerarioService(
            ...
            RelogioOutputPort relogioPort,
            TransacaoOutputPort transacaoPort) {
        return new FinanceiroNumerarioUseCase(
                numerarioPort,
                usuarioPort,
                relogioPort,
                transacaoPort
    ...
    @Bean
    MovimentacaoUseCase movimentacaoService(MovimentacaoOutputPort movimentacaoPort) {
        return new MovimentacaoUseCase(movimentacaoPort);
    }
    ...
    @Bean
    AutenticacaoUseCase autenticacaoService(
            UsuarioOutputPort usuarioPort,
            CodificadorSenhaOutputPort codificadorSenhaPort,
        ...
        return new AutenticacaoUseCase(
                ...
                relogioPort,
                limiteTentativas,
                Duration.ofMinutes(minutosBloqueio)
        );
    }
}
