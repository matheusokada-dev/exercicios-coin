...
public record DetalheSolicitacaoNumerarioResponse(
    ...
    public record OperacaoResumo(Long id, StatusOperacaoNumerario status,
            Long origemId, Long destinoId, BigDecimal valorProgramado,
            BigDecimal valorExpedido, BigDecimal valorRecebido,
            BigDecimal valorDivergencia, long versao) {}
    public record HistoricoResumo(Long id, EventoHistoricoSolicitacao evento,
            String statusAnterior, String statusNovo, Long usuarioId,
