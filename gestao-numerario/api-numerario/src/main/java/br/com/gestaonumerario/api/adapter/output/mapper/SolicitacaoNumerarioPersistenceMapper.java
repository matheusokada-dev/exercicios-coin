...
public class SolicitacaoNumerarioPersistenceMapper {
    ...
    public SolicitacaoNumerario toDomain(SolicitacaoAbastecimentoEntity e) {
        if (e == null)
            return null;
        return SolicitacaoNumerario.reconstituir(
                e.getId(),
                e.getTipoOperacao(),
                e.getAgencia()
                        .getId(),
                ...
                e.getDataDesejada(),
                e.getStatus(),
                usuarioMapper.toDomain(e.getSolicitante()),
                usuarioMapper.toDomain(e.getDecisor()),
                e.getJustificativaDecisao(),
                e.getDataCriacao(),
                e.getDataDecisao(),
                usuarioMapper.toDomain(e.getCanceladoPor()),
                e.getJustificativaCancelamento(),
                e.getDataCancelamento(),
                e.getDataAtendimento(),
                e.getVersao()
        );
    }
}
