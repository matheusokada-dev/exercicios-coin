...
public class SolicitacaoAbastecimentoRestMapper {
    ...
    public AprovarSolicitacaoCommand toCommand(
            Long solicitacaoId,
        ...
        return new AprovarSolicitacaoCommand(
                solicitacaoId,
                usuario.id(),
                request.justificativaDecisao(),
                request.justificativaEspecial()
        );
    }

    public RejeitarSolicitacaoCommand toCommand(
            Long solicitacaoId,
    ...
    public AtenderSolicitacaoCommand toCommand(
            Long solicitacaoId,
            AtenderSolicitacaoRequest request,
            UsuarioAutenticado usuario) {
        return new AtenderSolicitacaoCommand(
                solicitacaoId,
                usuario.id(),
    ...
    public SolicitacaoAbastecimentoResponse toResponse(SolicitacaoAbastecimento solicitacao) {
        return new SolicitacaoAbastecimentoResponse(
                ...
                solicitacao.getSolicitante()
                        .getId(),
                solicitacao.getDecisor() == null
                        ? null
                        : solicitacao.getDecisor()
                                .getId(),
