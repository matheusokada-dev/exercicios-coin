...
@Tag(
        name = "Solicitações de numerário",
...
public interface SolicitacaoNumerarioApi {
    ...
    @ApiResponses(
        {
                ...
                @ApiResponse(
                        responseCode = "400",
                        description = "Campo ausente ou inválido"
                ),
                @ApiResponse(
                        responseCode = "404",
                        description = "Agência ou usuário não encontrado"
                ),
                @ApiResponse(
                        responseCode = "409",
                        description = "Já existe solicitação aberta"
                ),
                @ApiResponse(
                        responseCode = "422",
    ...
    @Operation(
            summary = "Consultar histórico imutável da solicitação",
            description = "Lista cronologicamente todas as mudanças registradas para auditoria."
    )
